...
class Comment1Controller extends Controller
{
    ...
    {
        $comments=Comment::where('user_id',Auth::id())->first();
        return view('author.comments.comments',compact('comments'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('author.comments.commentEdit',compact('comment'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $comment->save();
        return back()->with('success','Comment Editing');
    }
