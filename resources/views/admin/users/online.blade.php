                                ...
                                @foreach($users as $us)
                                    @if($us->author==true)
                                        @if($us->isOnline())
                                            <tr>
                                        <td>
                                            <a href="{{route('uss',['id'=>$us->id])}}" data-toggle="modal" data-target="#docModal{{ $us->id }}" >
                                                <div class="img_cont">
                                                    <img src="/images/{{$us->avatar}}" class="rounded-circle user_img" alt="">
                                        ...
                                        <td class="text-nowrap text"><div class="user_info"><span>{{\Carbon\Carbon::parse($us->last_sign_in_at)->diffForHumans()}}</span></div></td>
                                            <td>
                                                {{-- <a href="{{route('userEdit',$us->id)}}" class="btn btn-sm btn-warning">
                                                <span class="fa fa-edit"></span></a> --}}
                                                <a href="{{route('ussId',$us->id)}}" class="btn btn-sm btn-info">
